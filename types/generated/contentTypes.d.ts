...
export interface ApiAccesInterneAccesInterne extends Struct.SingleTypeSchema {
  collectionName: 'acces_internes';
  info: {
    displayName: 'Acces-interne';
    pluralName: 'acces-internes';
    singularName: 'acces-interne';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::acces-interne.acces-interne'
    > &
      Schema.Attribute.Private;
    motdepasse: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEntrainementsLigneEntrainementsLigne
  ...
  info: {
    displayName: 'Entra\u00EEnements ligne';
    pluralName: 'entrainements-lignes';
    singularName: 'entrainements-ligne';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entraineurs: Schema.Attribute.String & Schema.Attribute.Required;
    horaires: Schema.Attribute.String & Schema.Attribute.Required;
    jours: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::entrainements-ligne.entrainements-ligne'
    > &
      Schema.Attribute.Private;
    naissance: Schema.Attribute.String & Schema.Attribute.Required;
    ordre: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    reprise: Schema.Attribute.String & Schema.Attribute.Required;
    tarifs: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::acces-interne.acces-interne': ApiAccesInterneAccesInterne;
